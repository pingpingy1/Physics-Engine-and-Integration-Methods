...
ggplot(tidy.x1.error, aes(x = Time, y = x1)) +
  ...
  scale_color_manual(values = c("red",
                     ...
                     labels = c("Explicit Euler",
                                "Simpletic Euler",
                                "Verlet")) +
  ggtitle("Spring with Length, Error of X-Position of Particle 1") +
  labs(x = "Time",
...
ggplot(tidy.all.error1.mag, aes(x = Time, y = error1)) +
  ...
  scale_linetype_manual(values = c("dashed",
                     ...
                     labels = c("No",
                                "Yes")) +
  ggtitle("Spring with Length, Magnitude of Error of Particle 1, With or Without Fluctuation") +
  labs(x = "Time",
       y = "Error",
       color = "Integration Method",
       linetype = "Fluctuation") +
...
ggplot(tidy.all.error2.mag, aes(x = Time, y = error2)) +
  ...
  scale_linetype_manual(values = c("dashed",
                        ...
                        labels = c("No",
                                   "Yes")) +
  ggtitle("Spring with Length, Magnitude of Error of Particle 2, With or Without Fluctuation") +
  labs(x = "Time",
       y = "Error",
       color = "Integration Method",
       linetype = "Fluctuation") +
