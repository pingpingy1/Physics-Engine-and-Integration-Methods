...
float springConst = 8, springLength = 100, inverseMass1 = 1, inverseMass2 = 4, rotRadius = 150;
float angularFreq = sqrt(springConst * (inverseMass1 + inverseMass2) * (1 - springLength/rotRadius));
PVector pos1 = new PVector(200 - rotRadius * inverseMass1 / (inverseMass1 + inverseMass2), 150);
PVector pos2 = new PVector(200 + rotRadius * inverseMass2 / (inverseMass1 + inverseMass2), 150);
PVector vel1 = new PVector(0, angularFreq * rotRadius * inverseMass1 / (inverseMass1 + inverseMass2));
PVector vel2 = new PVector(0, -angularFreq * rotRadius * inverseMass2 / (inverseMass1 + inverseMass2));
...
void setup() {
  ...
  e1 = new ExplicitEulerParticle(pos1.x, pos1.y, vel1.x, vel1.y, inverseMass1);
  e2 = new ExplicitEulerParticle(pos2.x, pos2.y, vel2.x, vel2.y, inverseMass2);

  s1 = new SympleticEulerParticle(pos1.x, pos1.y, vel1.x, vel1.y, inverseMass1);
  s2 = new SympleticEulerParticle(pos2.x, pos2.y, vel2.x, vel2.y, inverseMass2);

  v1 = new VerletParticle(pos1.x, pos1.y, vel1.x, vel1.y, inverseMass1);
  v2 = new VerletParticle(pos2.x, pos2.y, vel2.x, vel2.y, inverseMass2);

  es = new Spring(e1, e2, springConst, springLength);
  ss = new Spring(s1, s2, springConst, springLength);
  vs = new Spring(v1, v2, springConst, springLength);
